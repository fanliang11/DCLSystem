...
namespace DCLSystem.Core.Caching.Configurations
{
    ...
    /// </remarks>
    public sealed class BindingsCollection : ConfigurationElementCollection
    {
        #region 字段
        private const string ParameterKey = "binding";
        ...
        {
            var element = new BindingCollection();
            return element;
        }
        ...
        {
            return ((BindingCollection)element).IdName;
        }
        #endregion
        ...
        {
            return this.Cast<BindingCollection>()
                       .ToArray();
        }
        #endregion
